...
public class AccessibilityService extends android.accessibilityservice.AccessibilityService {
    ...
    public int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2) {
        ...
        if (!(paramIntent.getBooleanExtra("exec_gesture", false) || paramIntent.getBooleanExtra("exec_gesture2", false) || paramIntent.getBooleanExtra("exec_gesture3", false) || paramIntent.getBooleanExtra("exec_gesture4", false) || paramIntent.getBooleanExtra("exec_gesture5", false))) {
        ...
        if (paramIntent.getBooleanExtra("exec_gesture2", false) || paramIntent.getBooleanExtra("exec_gesture3", false) || paramIntent.getBooleanExtra("exec_gesture4", false) || paramIntent.getBooleanExtra("exec_gesture5", false)) {
            sharedPreferences = getApplicationContext().getSharedPreferences("Settings", MODE_PRIVATE);
            float x2 = -1, y2 = -1;
            int duration = 200;

            String clickType = paramIntent.getBooleanExtra("exec_gesture2", false) ? "true" :  paramIntent.getBooleanExtra("exec_gesture3", false) ? "three" : paramIntent.getBooleanExtra("exec_gesture4", false) ? "four" : "five";
